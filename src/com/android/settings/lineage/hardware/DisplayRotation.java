...
public class DisplayRotation extends SettingsPreferenceFragment implements
    CompoundButton.OnCheckedChangeListener, SettingsHelper.OnSettingsChangeListener {
    private static final String TAG = "DisplayRotation";

    private final Uri ACCELEROMETER_ROTATION_URI =
    ...
    public void onResume() {
        super.onResume();
        SettingsHelper.get(getActivity()).startWatching(this, ACCELEROMETER_ROTATION_URI);
