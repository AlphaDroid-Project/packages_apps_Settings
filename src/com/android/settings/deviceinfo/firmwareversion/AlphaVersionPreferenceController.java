...
public class AlphaVersionPreferenceController extends BasePreferenceController {
    ...
    private static final String ALPHA_BUILD_VERSION = "ro.alpha.build.version";
    private static final String KEY_ALPHA_VERSION = "alpha_version";
    private static final String ALPHA_BUILD_VARIANT = "ro.alpha.build.variant";
    ...
    public CharSequence getSummary() {
        ...
        String variant = SystemProperties.get(ALPHA_BUILD_VARIANT, "");
        if (TextUtils.isEmpty(variant)) return version;
